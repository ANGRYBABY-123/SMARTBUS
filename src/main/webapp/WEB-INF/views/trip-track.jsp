...
function initMap() {
  ...
  map = L.map('map', { center: initCenter, zoom: 13, zoomControl: false });
  ...
  if (ROUTE_START_LAT && ROUTE_END_LAT) {
    map.fitBounds(
      ...
      {paddingTopLeft: [60, 60], paddingBottomRight: [60, 220]}
    );
  }
